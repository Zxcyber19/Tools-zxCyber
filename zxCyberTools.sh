...
echo -b "AUTHOR    : Mr.zxCyber $green " |lolcat
echo -b "TEAM      : ANONYMOUS INDONESIA $green " |lolcat
echo -b "YOUTUBE   : mr.zxCyber $green " |lolcat
echo -b "NOTES     : GUNAKAN TOOLS DENGAN BIJAK " | lolcat
echo -b "_____________________________________________________________" | lolcat
...
sleep 1
echo -b $green"[#]> Mr.zxCyber On Your System" |lolcat

echo -b $green"[#]> See you Again SCRIPTzxCyber😎 :)..." |lolcat
figlet Mr . zxCyber | lolcat
sleep 1
exit
}
